...
\usepackage{tempora}		 % Times-совместимый шрифт с кириллицей (T2A) для pdflatex
\usepackage[english,russian]{babel}	 % RU — основной язык шаблона, EN доступен для текста
\usepackage{microtype}		 % уменьшает Overfull \hbox через protrusion/expansion шрифта
